...
/**
 * Represents a service for JSON Web Token authentication and authorization.
 */
@Service
public class JwtAuthService {

    // 256-bit encrypted key, generated here:
    ...
    private static final int TIME_UNTIL_EXPIRATION = 1000 * 60 * 120; // 2 hours
    ...
    // Used to verify the user is who they claim to be.
